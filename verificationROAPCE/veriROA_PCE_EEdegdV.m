function veriROA_PCE_EEdegdV(sys,fns,filenames,numsets)
    ...
    for jj=1:numsets.iteration_max
...
function [Smatres,Qvalres] = optimize_V(xi,numsets,degs,inicalc,multis,Smatold,gterm,Smatlist,Qvalsold)
    ...
    %F = [sos(eq1), sos(eq2), sos(mV.'*Qvals*mV - gterm), sos(xi.'*Smat*xi)]; %might give better numerical results
